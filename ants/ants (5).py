...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if not insect.is_ant():
            ...
            assert type(self.ant) is not QueenAnt,'cannot remove a queen'
            self.ant = None
        insect.place = None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        difference=self.max_range-self.min_range
        place=self.place
        start_point=self.min_range
        

        while place != hive and start_point!=0:
...
class QueenPlace(object):
    def __init__(self,place,old_place):
        self.place=place
        self.old_place=old_place
    @property
    def bee(self):
        return self.place.bees+self.old_place.bees
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor<=0:
            ...
            for elem in self.place.bees[:]:
                Insect.reduce_armor(elem,FireAnt.damage)
            self.place.remove_insect(self)
